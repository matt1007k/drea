...
class UsersCanCreateAnAlbumTest extends TestCase
{
    ...
    {
        $this->get(route('admin.albumes.create'))
    ...
    public function users_admin_can_see_page_create_post()
    {
        ...
        $this->actingAs($user)
            ->get(route('admin.albumes.create'))
    ...
    {
        $this->post(route('admin.albumes.store'), $this->formData())
            ->assertRedirect('/login');
    }
    ...
    public function users_admin_can_create_a_post()
    {
        ...
        $response = $this->actingAs($user)
            ->post(route('admin.albumes.store'), $this->formData([
                'imagen' => $image
            ]));
