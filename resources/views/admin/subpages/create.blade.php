...
@section('title', 'Registrar página del submenu: '. $submenu->titulo )
  ...
  <div class="mi-card m-b-0">
    <div class="mi-card-header bg-green">
      <div class="mi-title">
        ...
        <span>Registrar página de la ruta <strong>{{ $submenu->ruta }}</span>
      </div>
    </div>
  </div>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12 mx-auto">
      <div class="mi-card">
        <div class="mi-card-content">
          <form action="{{ route('admin.menus.submenus.pages.store', [$menu, $submenu]) }}" method="POST">
