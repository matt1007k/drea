...
<div class="form-group">
  <div class="mi-input @error('titulo') mi-error @enderror">
    ...
    <input type="text" name="titulo" id="titulo" class="form-control " value="{{ old('titulo', $menu->titulo) }}"
...
<div class="d-flex justify-content-between mt-4">
  ...
  <a href="{{ route('admin.menus.index') }} " class="btn btn-danger text-uppercase">
    Cancelar
